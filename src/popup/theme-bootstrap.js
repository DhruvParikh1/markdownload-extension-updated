(function () {
  ...
  const normalizeColorBlindTheme = (value) => ['deuteranopia', 'protanopia', 'tritanopia'].includes(value) ? value : 'deuteranopia';
  const getResolvedSpecialThemeKey = (specialTheme, colorBlindTheme) => {
